...
public interface SysRoleService extends IService<SysRole> {
    ...
    Page selectSysRolePage(Query<Object> objectQuery, EntityWrapper<Object> objectEntityWrapper);

    Page selectImeetingRolePage(Query<Object> objectQuery, EntityWrapper<Object> objectEntityWrapper);
     ...
     * @date 2019/1/2 11:46
     */
    String getSysRoleLevel(String userName);
}
