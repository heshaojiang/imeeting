...
public class Encrpt {
    ...
    public static Encoder encode = Base64.getEncoder();
    public static String EncriptWRSA_Pub(String data,String path) throws Exception{
        ...
        try {
            ...
            return encode.encodeToString(outStream.toByteArray());//encodeBase64(outStream.toByteArray());
    ...
    public static String EncriptWRSA_Pri(String data,PrivateKey privateKey) throws Exception {
        String encryptData ="";
        ...
        try {
            ...
            return encode.encodeToString(outStream.toByteArray());
        } catch (IllegalBlockSizeException e) {
            e.printStackTrace();
        } catch (BadPaddingException e) {
            e.printStackTrace();
    ...
    public static String EncriptWRSA_Pri(String data,String path) throws Exception{
        ...
        return EncriptWRSA_Pri(data,privateKey);
    }
    public static String DecriptWithRSA_Pub(String data,PublicKey publicKey) throws Exception{
        Cipher cipher = Cipher.getInstance("rsa");
        SecureRandom random = new SecureRandom();

//        byte[] bEncrypt = decoder.decodeBuffer(data);
        byte[] bEncrypt = decoder.decode(data);
        if (bEncrypt == null){
            return "";
        }
        //私钥解密
    ...
    public static String DecriptWithRSA_Pub(String data,String path) throws Exception{
        ...
        // 获得公钥
        PublicKey publicKey = x509Certificate.getPublicKey();
        return DecriptWithRSA_Pub(data,publicKey);
    }
