...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements SysRoleService {
    ...
    @Override
    public Page selectSysRolePage(Query<Object> query, EntityWrapper<Object> objectEntityWrapper) {
        query.setRecords(sysRoleMapper.selectSysRolePage(query, query.getCondition()));
        return query;
    }

    @Override
    public Page selectImeetingRolePage(Query<Object> query, EntityWrapper<Object> objectEntityWrapper) {
        query.setRecords(sysRoleMapper.selectImeetingRolePage(query, query.getCondition()));
        return query;
    }
    ...
    @Override
    public String getSysRoleLevel(String userName) {
        UserVo userVo = sysUserService.findUserByUsername(userName);
        String level = userVo.getRoleList().get(0).getLevel();
