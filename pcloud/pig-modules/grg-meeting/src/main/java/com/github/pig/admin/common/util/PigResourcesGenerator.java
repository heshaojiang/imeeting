...
public class PigResourcesGenerator {
    ...
    public static void main(String[] args) {
        String outputDir = "E:\\pcloud";
//        String outputDir = "/home/xguo/design/";
        final String viewOutputDir = outputDir + "/ResourcesGenerator/";
        ...
        dsc.setUsername("imeeting");
        dsc.setPassword("grg@123");
        dsc.setUrl("jdbc:mysql://imeeting-db:3306/imeeting?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false");
