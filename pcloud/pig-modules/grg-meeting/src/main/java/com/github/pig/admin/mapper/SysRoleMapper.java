...
public interface SysRoleMapper extends BaseMapper<SysRole> {
    ...
    List<Object> selectSysRolePage(Query<Object> query, Map<String, Object> condition);

    List<Object> selectImeetingRolePage (Query<Object> query, Map<String, Object> condition);
