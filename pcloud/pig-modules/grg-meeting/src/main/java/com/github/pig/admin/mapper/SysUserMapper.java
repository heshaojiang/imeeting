...
public interface SysUserMapper extends BaseMapper<SysUser> {
     ...
     * @return list
     */
    List selectUserVoPageForAdmin(Query query, DataScope dataScope);
    ...
    List<UserVo> selectUserVoByCustomerId(Integer id);
     ...
     * @author: wjqiu
     * @date: 2019-01-17
     * @description: 查找是否存在此用户名或手机号的用户
     */
    UserVo selectUserVoByNameOrCall(String name);
