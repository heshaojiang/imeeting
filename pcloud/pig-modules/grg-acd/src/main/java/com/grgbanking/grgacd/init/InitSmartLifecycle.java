package com.grgbanking.grgacd.init;
...
@Component
@Slf4j
public class InitSmartLifecycle implements SmartLifecycle {
    @Autowired
    ...
    @Override
    public void start() {
        log.info("--------------------- Start ACD initializer --------------");

        acdQueueService.initQueue();
