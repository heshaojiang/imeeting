    ...
    const menu = (
      <Menu className={styles.menu} selectedKeys={[]} onClick={onMenuClick}>
        ...
        < Menu.Item key="license">
          <Icon type="copyright" />
          <FormattedMessage id="menu.license" defaultMessage="license" />
          </Menu.Item>
        }
          ...
          <Dropdown overlay={menu}>
            <span className={`${styles.action} ${styles.account}`}>
              <Avatar
                ...
                alt="avatar"
              />
              <span className={styles.name}>{currentUser.username==="admin"?formatMessage({ id: 'app.admin.adminusername'}):currentUser.nickname}</span>
            </span>
          </Dropdown>
        ) : (
